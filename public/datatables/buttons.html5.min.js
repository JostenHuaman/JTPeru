    ...
    function z(a) {
        ...
        { match: /^\-?[\d,]+\.\d{2}$/, style: 64 }];
         ...
         o.ext.buttons.excelHtml5 = {
            className: "buttons-excel buttons-html5", available: function () { return j.FileReader !== s && (v || j.JSZip) !== s && !I() && y }, text: function (a) { return a.i18n("buttons.excel", "Excels") }, action: function (a, b, d, c) {
